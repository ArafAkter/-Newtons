...
function setup() {
 ...
 roof1 = createSprite(400,100,50,50)
 roof2 = createSprite(450,100,50,50)
 roof3 = createSprite(500,100,50,50)
 roof4 = createSprite(550,100,50,50)
 roof5 = createSprite(600,100,50,50)

roof = createSprite(width/2, 100, 300, 50);
roof.shapeColor="mediumblue"
...
line(ball2.x,ball2.y,roof1.x,roof1.y)
line(ball3.x,ball3.y,roof2.x,roof2.y)
line(ball4.x,ball4.y,roof3.x,roof3.y)
line(ball5.x,ball5.y,roof4.x,roof4.y)
line(ball1.x,ball1.y,roof5.x,roof5.y)
